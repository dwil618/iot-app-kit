...
## [8.0.0](https://github.com/dwil618/iot-app-kit/compare/root-v7.3.1...root-v8.0.0) (2023-09-18)
...
* **3D Knowledge Graph:** add scene node highlighting ([ef5c71c](https://github.com/dwil618/iot-app-kit/commit/ef5c71c7d54f81c85b61f4a10847957669c1bdfb))
* **3D Knowledge Graph:** create function for duplicate code ([4c239d8](https://github.com/dwil618/iot-app-kit/commit/4c239d85211f2609fc5f312a3c725c881cd187f5))
* **3D Knowledge Graph:** fix lint after rebase ([e016ff7](https://github.com/dwil618/iot-app-kit/commit/e016ff747a156d48043ec9ed5b1aa2cfbb8b58a2))
* **3D Knowledge Graph:** fix type import ([e1edc38](https://github.com/dwil618/iot-app-kit/commit/e1edc38905c5cc299d207568697b1d099791df6b))
* **3D Knowledge Graph:** improve unit tests ([11cd450](https://github.com/dwil618/iot-app-kit/commit/11cd45022198ed4b1f69623080237617557f2136))
* **3D Knowledge Graph:** improve useStore usage and unit tests ([f10ffb2](https://github.com/dwil618/iot-app-kit/commit/f10ffb2a72a1e5cb3bf1dbf9f1e0bc2e9fdd35d9))
* **3D knowledge Graph:** selecting entity binding triggers camera movement ([f122f1a](https://github.com/dwil618/iot-app-kit/commit/f122f1a3a7d7af14060099263208801af3738ac3))
* **3D Knowledge Graph:** update DataBinding to EntityBinding ([ca10d1b](https://github.com/dwil618/iot-app-kit/commit/ca10d1b3319f8c10b7239080310e4b0ad4244775))
* **3D Knowledge Graph:** use updated entity binding definition ([97d6d91](https://github.com/dwil618/iot-app-kit/commit/97d6d9104fb9e28dc23b1c6850b43f463a0fcb17))
* **3dkg:** 3dkg release ([7c01c91](https://github.com/dwil618/iot-app-kit/commit/7c01c911936314b4b99614c367e2bc6f6522a024))
* **3dkg:** added 3dkg changes for entity data binding ([4db11a6](https://github.com/dwil618/iot-app-kit/commit/4db11a63a6fb1ef2b3dd1cc5682a64e1417b12da))
...
* **composer:** add hook to convert data bindings to queries ([1e68022](https://github.com/dwil618/iot-app-kit/commit/1e6802206312926efbbf2e15fd48379afbfc4cd9))
* **composer:** auto query for indicator and overlay ([b597c6f](https://github.com/dwil618/iot-app-kit/commit/b597c6f7606ead54749e93e0be2436430155b634))
* **composer:** auto query support for Model Shader ([ff0bbe3](https://github.com/dwil618/iot-app-kit/commit/ff0bbe3a9cb1f6c8a91cf6c4f531b1811eee076c))
...
* **composer:** support enhanced editing in Matterport scene ([933deb7](https://github.com/dwil618/iot-app-kit/commit/933deb752d11ab9269b48eccff9348c771f22019))
* **composer:** support sync matterport tag as entities ([7db178a](https://github.com/dwil618/iot-app-kit/commit/7db178a4aee74cbd299dc115c7cf3786dc376800))
...
* **dynamic scenes:** update entities using dynamic scenes ([8eee582](https://github.com/dwil618/iot-app-kit/commit/8eee582e039a5cb2a3e25c81f822a4ecca95672c))
...
* **first Person:** proof of using pointer lock for a first person view ([391eddd](https://github.com/dwil618/iot-app-kit/commit/391edddd5ab3c56be2e394aec06346dfbc29b776))
* fix lint error for scene composer ([924547f](https://github.com/dwil618/iot-app-kit/commit/924547f788f260efa3cd39d36ede79b6c00f4f23))
...
* **propertyName:** add copy button and textarea ([7c0eaf4](https://github.com/dwil618/iot-app-kit/commit/7c0eaf432e40e25a5319a29e7546442d81e8c3dc))
...
* **scene composer:** add unit test for AnchorWidget onClickWidget event ([07f0987](https://github.com/dwil618/iot-app-kit/commit/07f0987cd5effaafbc20e5936800bb447a244874))
* **scene composer:** added feature flag for tagstyle feature ([53a66ff](https://github.com/dwil618/iot-app-kit/commit/53a66ffbdf0805c2ea6023f1903dbc117ca9d721))
* **scene composer:** added icon picker changes ([8ca53b8](https://github.com/dwil618/iot-app-kit/commit/8ca53b8552f9eb09f107ea43d983a6b47f19fa88))
* **scene composer:** color picker bug fixes ([f44b838](https://github.com/dwil618/iot-app-kit/commit/f44b838198165f60722bd83f4e4ae42c185e7146))
* **scene composer:** color picker changes ([0138b0a](https://github.com/dwil618/iot-app-kit/commit/0138b0adb20039e77dc4ac0f838a50d742d24339))
* **scene composer:** entity data binding UI changes and unit tests ([fc17202](https://github.com/dwil618/iot-app-kit/commit/fc17202c73a28a8670a8e4bc028eee86ac1a4ed1))
* **scene composer:** entity data binding UI changes and unit tests ([f1f81b8](https://github.com/dwil618/iot-app-kit/commit/f1f81b8e9d11734836582071d4583113af5510a2))
* **scene composer:** fix autosuggestvalue issues in ValueDataBindingBuilder ([0f32e73](https://github.com/dwil618/iot-app-kit/commit/0f32e7367f01b09d0f81eaf7580e770fcf523a2f))
* **scene composer:** fixed entity data binding data format ([64e33fa](https://github.com/dwil618/iot-app-kit/commit/64e33fa582512868a74d1cafad1a0d734065878c))
* **scene composer:** fixed entity search bug using free text ([7417c15](https://github.com/dwil618/iot-app-kit/commit/7417c15f09b3b7b2c1994d1ee13aeb98e8506779))
* **scene composer:** rule icon using color picker ([f1519c4](https://github.com/dwil618/iot-app-kit/commit/f1519c4ec94c598a83825f85a3dcd00e87747e3f))
* **scene-composer:** added back animation scene model component with changes ([39f14cd](https://github.com/dwil618/iot-app-kit/commit/39f14cd0d0f571e9c4bbc04958baecd4530d04f5))
* **scene-composer:** added comment to explain scene object fetching ([39f14cd](https://github.com/dwil618/iot-app-kit/commit/39f14cd0d0f571e9c4bbc04958baecd4530d04f5))
* **scene-composer:** added internationalization for animation viewstate ([39f14cd](https://github.com/dwil618/iot-app-kit/commit/39f14cd0d0f571e9c4bbc04958baecd4530d04f5))
* **scene-composer:** added knowncomponent type to condition for adding an animation object ([39f14cd](https://github.com/dwil618/iot-app-kit/commit/39f14cd0d0f571e9c4bbc04958baecd4530d04f5))
* **scene-composer:** addressed changes to databinding in the add component menu ([39f14cd](https://github.com/dwil618/iot-app-kit/commit/39f14cd0d0f571e9c4bbc04958baecd4530d04f5))
* **scene-composer:** addressed more changes to databinding in the add component menu ([39f14cd](https://github.com/dwil618/iot-app-kit/commit/39f14cd0d0f571e9c4bbc04958baecd4530d04f5))
* **scene-composer:** fixed tests ([39f14cd](https://github.com/dwil618/iot-app-kit/commit/39f14cd0d0f571e9c4bbc04958baecd4530d04f5))
* **scene-composer:** fixed use effect in animationeditor to prevent extra fire ([39f14cd](https://github.com/dwil618/iot-app-kit/commit/39f14cd0d0f571e9c4bbc04958baecd4530d04f5))
* **scene-composer:** got rid of magic string and replaced it with a const ([39f14cd](https://github.com/dwil618/iot-app-kit/commit/39f14cd0d0f571e9c4bbc04958baecd4530d04f5))
* **scene-composer:** initial implementation of animations ([39f14cd](https://github.com/dwil618/iot-app-kit/commit/39f14cd0d0f571e9c4bbc04958baecd4530d04f5))
* **scene-composer:** minor cleanup ([39f14cd](https://github.com/dwil618/iot-app-kit/commit/39f14cd0d0f571e9c4bbc04958baecd4530d04f5))
* **scene-composer:** refactored addObject menu for animations ([39f14cd](https://github.com/dwil618/iot-app-kit/commit/39f14cd0d0f571e9c4bbc04958baecd4530d04f5))
* **scene-composer:** refactored AnimationComponent test ([39f14cd](https://github.com/dwil618/iot-app-kit/commit/39f14cd0d0f571e9c4bbc04958baecd4530d04f5))
* **scene-composer:** refactored tests and animationComponentEditor ([39f14cd](https://github.com/dwil618/iot-app-kit/commit/39f14cd0d0f571e9c4bbc04958baecd4530d04f5))
* **scene-composer:** refactored to address github feedback ([39f14cd](https://github.com/dwil618/iot-app-kit/commit/39f14cd0d0f571e9c4bbc04958baecd4530d04f5))
* **scene-composer:** removed changes to tag component ([39f14cd](https://github.com/dwil618/iot-app-kit/commit/39f14cd0d0f571e9c4bbc04958baecd4530d04f5))
* **scene-composer:** removed global variable from animationcomponent ([39f14cd](https://github.com/dwil618/iot-app-kit/commit/39f14cd0d0f571e9c4bbc04958baecd4530d04f5))
* **scene-composer:** removed unnecessary dependency ([39f14cd](https://github.com/dwil618/iot-app-kit/commit/39f14cd0d0f571e9c4bbc04958baecd4530d04f5))
* **scene-composer:** removed unnecessary imports ([39f14cd](https://github.com/dwil618/iot-app-kit/commit/39f14cd0d0f571e9c4bbc04958baecd4530d04f5))
* **scene-composer:** renamed animationupdater to animationcomponenteditor for consistency ([39f14cd](https://github.com/dwil618/iot-app-kit/commit/39f14cd0d0f571e9c4bbc04958baecd4530d04f5))
* **scene-composer:** reverted package-lock.json ([39f14cd](https://github.com/dwil618/iot-app-kit/commit/39f14cd0d0f571e9c4bbc04958baecd4530d04f5))
* **scene-composer:** updated us.json ([39f14cd](https://github.com/dwil618/iot-app-kit/commit/39f14cd0d0f571e9c4bbc04958baecd4530d04f5))
...
* **actions:** lock release please to version ([aba8511](https://github.com/dwil618/iot-app-kit/commit/aba85114467119d4999f25a3e175c5761ca018f3))
* **composer:** add new translations ([de7249a](https://github.com/dwil618/iot-app-kit/commit/de7249a8a920e1c43faeda4fd94fb57e9d0fc9f3))
* **composer:** click events for tag and overlay ([2bf7b13](https://github.com/dwil618/iot-app-kit/commit/2bf7b13fc2eccc1206eb9455d372d84c0a886915))
* **composer:** click on overlay causing camera to follow mouse ([6cbd5f5](https://github.com/dwil618/iot-app-kit/commit/6cbd5f5d53cf8b58ba5d4d7536acd9acd6ac7ad1))
* **composer:** close overlay auto select attached tag ([5a52ae1](https://github.com/dwil618/iot-app-kit/commit/5a52ae18e4d37135570765a12306bbece3655eb8))
...
* **composer:** error when switching motion indicator appearance ([c51f135](https://github.com/dwil618/iot-app-kit/commit/c51f13530b36c8a7e1e17d8ea65c4bec515fb16d))
* **composer:** fix infinite storybook component update ([40fab0a](https://github.com/dwil618/iot-app-kit/commit/40fab0a96bf1a0396fa0a36aa67c059ed8570cfc))
* **composer:** fix issue displaying 0 in overlay ([a0bc01d](https://github.com/dwil618/iot-app-kit/commit/a0bc01dfe327509345ec74a61149a6a2d6e48a6a))
* **composer:** fix warning and cached onChange ([5a2c182](https://github.com/dwil618/iot-app-kit/commit/5a2c1824736bfdd05d1dd1925da8a0408c7ca860))
* **composer:** matterport tag sync tag style under flag ([83334ce](https://github.com/dwil618/iot-app-kit/commit/83334ce21a089ecff46c86ddfb320f1bafe6011d))
* **composer:** unsubscribe to queries when unmounting ([15fe82e](https://github.com/dwil618/iot-app-kit/commit/15fe82edf847cf024ab8e987ff513d4726cb2138))
...
* **data overlay:** add onWidgetClick and onSelectionChange event support to data overlays ([b3f4f9d](https://github.com/dwil618/iot-app-kit/commit/b3f4f9d33e61190933323f283fe0fe0552ab0384))
* **docs:** udpate dataStream docs ([d0dc6ca](https://github.com/dwil618/iot-app-kit/commit/d0dc6cace63508480a76db9e0151532fd387a891))
...
* **matterport:** fix zoom to tag ([49a04f8](https://github.com/dwil618/iot-app-kit/commit/49a04f81bc464d20798f219f77f325bde74ad1f6))
...
* **reactExample:** fix css in Knowledge Graph Component ([7b5a4e4](https://github.com/dwil618/iot-app-kit/commit/7b5a4e452b1e4cee2ec13220b0b2c828906f27db))
* **reactExample:** fix removed css in Scene Viewer Component ([7f38586](https://github.com/dwil618/iot-app-kit/commit/7f38586400dfea06d8e2f986130fceddae719e60))
...
* **scene composer:** cleanup for polaris css imports & moving interface to component file ([d244eb5](https://github.com/dwil618/iot-app-kit/commit/d244eb525a3b2ae8862affa0141673351fd850ee))
* **scene composer:** collapse scene panels on scene load ([0841e64](https://github.com/dwil618/iot-app-kit/commit/0841e6409b7bea5c516022c09cc9e1a936bbf81b))
* **scene composer:** fix for broken rule panel ([c5e071d](https://github.com/dwil618/iot-app-kit/commit/c5e071d6c5c0e73eaec3e47a98e6d3e3f0cc7dc3))
* **scene composer:** fix for missing grid ([2a4c4c8](https://github.com/dwil618/iot-app-kit/commit/2a4c4c8b194a2eceebe73dc87d24215836be4a99))
* **scene composer:** fix overlay arrow clickable space ([4cae31f](https://github.com/dwil618/iot-app-kit/commit/4cae31fb04d38852ed667ab5620d4920cfd83769))
* **scene composer:** fix spacing issue between elements ([b65ebdc](https://github.com/dwil618/iot-app-kit/commit/b65ebdc3fecd4911a6e5fbc664d1d0bdf5524ebe))
* **scene composer:** modifying auto collapse to only apply to viewer ([aaf6338](https://github.com/dwil618/iot-app-kit/commit/aaf63384b7d24b731a76fec10b8372110173470e))
...
* **scene composer:** reverting breaking changes from dependabot & setting up ignores ([831d1d7](https://github.com/dwil618/iot-app-kit/commit/831d1d76e8f7f36bd8129eaa7491a33516a57b1c))
* **scene composer:** sets up refs to track visibility of data overlay & parent ([fad2208](https://github.com/dwil618/iot-app-kit/commit/fad22087312570641809ed4b1662ae053a809f02))
* **scene tags:** fix anchor stems not triggering onWidgetClick ([6945512](https://github.com/dwil618/iot-app-kit/commit/6945512eadbdd8d8bc09977ecce7511fbf136311))
* **scene-composer:** fix ability to click on tags, revert raycaster disable on scroll ([caed238](https://github.com/dwil618/iot-app-kit/commit/caed238ed12da29bd487caf44b895ce7f7f024bf))
* **scene-composer:** update raycaster in OrbitControls, ignore undefined faces, disable on scroll ([011464e](https://github.com/dwil618/iot-app-kit/commit/011464e702f46b9237b8df1226fa862c073605c0))
* **scene-composer:** updating dependabot.yml to properly ignore all [@react-three](https://github.com/react-three) dependencies ([a33d445](https://github.com/dwil618/iot-app-kit/commit/a33d445309f31da54dcc443b3e2ee604014c153a))
* **Tag style:** custom color to support icon rules ([dd3bbee](https://github.com/dwil618/iot-app-kit/commit/dd3bbee9622eb0bda3a29ab28b920b6d798b4cb2))
...
* **tools-iottwinmaker:** update dashboard role to include execute query api ([b63d053](https://github.com/dwil618/iot-app-kit/commit/b63d0537ce247724d0dd73d8d0d1ffba20e0ab5a))
